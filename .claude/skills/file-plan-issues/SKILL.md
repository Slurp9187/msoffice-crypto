...
Protocol: [docs/plan-workflow.md](../../../docs/plan-workflow.md). Read it before filing.
Borrowed from the sibling crate `odf-crypto`, where the protocol was worked out; the
arc waiting to be filed here is
[docs/plans/msoffice-crypto-foundation-2026-09-04.md](../../../docs/plans/msoffice-crypto-foundation-2026-09-04.md),
whose slice table is already written in the Work / Done-when shape step 2 expects. Do not invent a board, a terminator sibling, or a checklist of slices on the parent.
