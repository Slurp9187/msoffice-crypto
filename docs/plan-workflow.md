...
Borrowed verbatim from [`odf-crypto`](https://github.com/Slurp9187/odf-crypto)'s
`docs/plan-workflow.md`, which is the sibling crate and the worked example. Its
detection arc — plan file → parent [#1](https://github.com/Slurp9187/odf-crypto/issues/1),
slices [#2](https://github.com/Slurp9187/odf-crypto/issues/2)–[#7](https://github.com/Slurp9187/odf-crypto/issues/7) —
is what this protocol was written against. This repo's first arc is
[docs/plans/msoffice-crypto-foundation-2026-09-04.md](plans/msoffice-crypto-foundation-2026-09-04.md); its
issues are not filed yet.
...
## Slice quality (from odf-crypto #1)
...
Agents file this shape via the project skill `file-plan-issues`, which is not yet
copied into this repo. This file is
